...
module.exports =
{
  ...
  create : function()
  {
    ...
    if(body.length > 0)
    {
      ...
      console.log("Role = " + Game.creeps[res].memory.role + ", is spawning " + Game.creeps[res].spawning);
  ...
  {
    console.log("Harvester check_and_set_to_farm! " + harvester.name);
  ...
  {
    console.log("Harvester init! " + harvester.name);
