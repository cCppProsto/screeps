...
{ 
  ...
  //if(Game.creeps['Cameron'] != null)
  //  console.log("OK");
  //console.log(Game.rooms[Game.spawns.s1.memory.RoomID].energyAvailable + " : " + Game.rooms[Game.spawns.s1.memory.RoomID].energyCapacityAvailable);
